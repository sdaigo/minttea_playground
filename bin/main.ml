...
(* takes the initial state and returns Mint Tea `Command` that kicks off the app. *)
let init _model = Command.Noop

(* update function gets called whenever "things happen"
   Event -> model -> model * Command *)
